  ...
  <div class="w-full md:w-3/4 lg:w-3/5 p-5 md:px-12 lg:24 h-full overflow-x-scroll scrollbar-hide antialiased">
    ...
    <div class="mt-3 flex flex-col">
      ...
      <div class="bg-[#040F16] mt-3">
        <div class="bg-[#040F16] shadow p-3 text-3xl text-white font-comfortaa">
          {/* POST USERNAME */}
          <div style={{cursor:"pointer"}} onClick={handleClick}>USERNAME</div>
          {showProfile && <Profile />}
        </div>
        <div class="bg-[#040F16] border border-[#F79764] shadow p-5 text-xl text-white font-comfortaa">
          {/* POST BODY */}
        ...
        <div class="bg-[#A288E3] p-1 border border-[#F79764] shadow flex flex-row flex-wrap justify-center">
          <div class="w-1/3 hover:bg-[#F79764] border-4 text-center text-xl text-white font-comfortaa">Like</div>
          <div class="w-1/3 hover:bg-[#F79764] border-4 text-center text-xl text-white font-comfortaa">Comment</div>
        </div>
