...
const Support = () => {
  return (
    <div class="bg-[#040F16] flex justify-center h-screen p-4 py-1 ">
      <div class=" mx-auto w-full py-2 max-w-[550px]">
        ...
        <form action="https://getform.io/f/07e3a107-6dc3-47d1-9663-d20ef83bc3ca" method="POST">
          ...
          <div class="mb-5">
            ...
            <input
              ...
              class="hover:placeholder-white hover:bg-[#A288E3] w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
            />
          </div>
          <div class="mb-5">
            <label
          ...
          <div class="flex items-center py-1 justify-center">
            ...
            >
              <span class="bg-[#A288E3] p-1"><IoIosHelpCircleOutline /> </span> Support
            </button>
          </div>
        </form>
      </div>
